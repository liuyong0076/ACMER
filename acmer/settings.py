"""
Django settings for acmer project.
...
SECRET_KEY = 'jb5x-^e4zj^+t900#m7l)b9l@&gy_g#9u64=k7ijauxi=r2ce@'
...
INSTALLED_APPS = [
    'acmerdata.apps.AcmerdataConfig',
...
WSGI_APPLICATION = 'acmer.wsgi.application'
